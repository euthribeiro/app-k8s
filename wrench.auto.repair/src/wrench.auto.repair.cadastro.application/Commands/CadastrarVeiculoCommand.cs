...
namespace wrench.auto.repair.cadastro.application.Commands
{
    ...
    ) : Command<Guid>
    {
        ...
        public static implicit operator CadastrarVeiculoCommand(CadastrarVeiculoViewModel viewModel) =>
            new(
                viewModel.ClienteId,
                viewModel.Marca,
                viewModel.Modelo,
                viewModel.Cor,
                viewModel.AnoFabricacao,
                viewModel.AnoModelo,
                viewModel.PlacaDoVeiculo,
                viewModel.Descricao,
                viewModel.UltimaRevisao,
                viewModel.QuilometragemAtual
            );
    }
